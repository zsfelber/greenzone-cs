...
namespace BasicUtil_CS.gui
{
    ...
    public partial class ConsoleForm : Form
    {
        ...
        public ConsoleForm()
        {
            ...
            Console.WriteLine("ConsoleForm has been initialized.");

            MxEnter = new Object();
        }

        public static void ShowAsApplication()
        {
        ...
        public static void ShowAsAppInNewThread()
        {
            Application.EnableVisualStyles();
            Application.SetCompatibleTextRenderingDefault(false);

            var t = new Thread(ShowAsApplication);
            t.Start();
        }

        public static void ShowAsDialogInNewThread()
        {
            Application.EnableVisualStyles();
            Application.SetCompatibleTextRenderingDefault(false);

            var t = new Thread(ShowAsDialog);
            t.Start();
        }
    ...
    internal class TextBoxReader : ReadLineTextReader
    {
        TextBox _input;
        object _mutex;

        public TextBoxReader(TextBox input, object mutex)
        {
            _input = input;
            _mutex = mutex;
        }
