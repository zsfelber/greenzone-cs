...
namespace EnvironmentAssistant
{
	public class ImportMetatraderPage1 : AssistantPage
	{
        ...
        private EnvironmentAssistantForm EAF
        {
            get
            {
                return (EnvironmentAssistantForm)Assistant;
            }
        }
        ...
        protected override bool OnSetActive()
        {
            ...
            if (EAF.UpdatedEnvironment != null)
            {
                ...
                if (!found)
                {
                    dataGridView1.Rows.Add(EAF.UpdatedEnvironmentDir, EAF.UpdatedEnvironmentType);
        ...
        {
            return typeof(ImportMetatraderPage2).Name;
        }
        ...
        private bool ParseDirectory(string mt4dir)
        {
            ...
            {
                dataGridView1.Rows.Add(mt4dir, "Metatrader 4");
                return true;
            }
            else
            {
