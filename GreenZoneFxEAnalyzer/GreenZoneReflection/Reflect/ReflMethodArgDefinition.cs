...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflMethodArgDefinition(Resolver resolver, IParser parser, INode parseNode, ReflType parameterType, string methodParameterName, ReflMethodArgType argType, params ReflAttribute[] attributes)
