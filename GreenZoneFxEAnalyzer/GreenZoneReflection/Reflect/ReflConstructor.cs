...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflConstructor(Resolver resolver, IParser parser, INode parseNode, int id, ReflObjType declaringType, ReflModifier modifiers, ReflAttribute[] attributes, params ReflMethodArgDefinition[] methodArgs)
