...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflMethodBaseGen(Resolver resolver, Parser parser, BaseNode parseNode, int id, ReflCallableType declaringType, string methodName, ReflModifier modifiers, ReflAttribute[] attributes, params ReflMethodArgDefinition[] methodArgs)
