...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflProperty(Resolver resolver, Parser parser, BaseNode parseNode, int id, ReflObjType declaringType, ReflType propertyType, ReflPropertyMethodType propertyMethodType, string propertyName, ReflModifier modifiers, ReflModifier setModifiers, ReflAttribute[] attributes)
