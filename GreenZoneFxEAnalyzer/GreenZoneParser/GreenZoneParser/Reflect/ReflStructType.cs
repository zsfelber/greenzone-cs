...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflStructType(Resolver resolver, Parser parser, BaseNode parseNode, int id, string namespaceId, string typeName, ReflType baseType, ReflModifier modifiers)
            : base(resolver, parser, parseNode, id, namespaceId, typeName, modifiers)
        {
            this.baseType = baseType;
        }

        internal ReflStructType(Resolver resolver, Parser parser, BaseNode parseNode, int id, ReflDefType parentType, string typeName, ReflType baseType, ReflModifier modifiers)
