...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflEventAdd(Resolver resolver, Parser parser, BaseNode parseNode, int id, ReflObjType declaringType, ReflEvent parent, ReflModifier modifiers, ReflAttribute[] attributes)
