...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflCallableType(Resolver resolver, Parser parser, BaseNode parseNode, int id, string namespaceId, string typeName, ReflModifier modifiers)
        ...
        internal ReflCallableType(Resolver resolver, Parser parser, BaseNode parseNode, int id, ReflDefType parentType, string typeName, ReflModifier modifiers)
        ...
        internal ReflCallableType(Resolver resolver, Parser parser, BaseNode parseNode, int id, string namespaceId, string typeName, ReflModifier modifiers, List<ReflTypeArgDefinition> genericTypeArgDefs)
            : base(resolver, parser, parseNode, id, namespaceId, typeName, modifiers)
        {
        ...
        internal ReflCallableType(Resolver resolver, Parser parser, BaseNode parseNode, int id, ReflDefType parentType, string typeName, ReflModifier modifiers, List<ReflTypeArgDefinition> genericTypeArgDefs)
            : base(resolver, parser, parseNode, id, parentType, typeName, modifiers)
        {
            this.genericTypeArgDefs = genericTypeArgDefs;
            this.genericTypeArgDefsUm = this.genericTypeArgDefs.AsReadOnly();
