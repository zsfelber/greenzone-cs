...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflClassType(Resolver resolver, Parser parser, BaseNode parseNode, int id, string namespaceId, string typeName, ReflClassType baseClass, ReflModifier modifiers)
            : base(resolver, parser, parseNode, id, namespaceId, typeName, modifiers)
        {
            this.baseClass = baseClass;
        }

        internal ReflClassType(Resolver resolver, Parser parser, BaseNode parseNode, int id, ReflDefType parentType, string typeName, ReflClassType baseClass, ReflModifier modifiers)
