...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflEnumType(Resolver resolver, IParser parser, INode parseNode, int id, string namespaceId, string typeName, ReflType baseType, ReflModifier modifiers)
        ...
        internal ReflEnumType(Resolver resolver, IParser parser, INode parseNode, int id, ReflDefType parentType, string typeName, ReflType baseType, ReflModifier modifiers)
