...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflMember(Resolver resolver, IParser parser, INode parseNode, int id, string namespaceId, string name, ReflModifier modifiers)
        ...
        internal ReflMember(Resolver resolver, IParser parser, INode parseNode, int id, ReflCallableType declaringType, string name, ReflModifier modifiers)
        ...
        internal ReflMember(Resolver resolver, IParser parser, INode parseNode, int id, string namespaceId, string name, ReflModifier modifiers, ReflAttribute[] attributes)
            : base(resolver, parser, parseNode, null)
        {
            isTopLevel = true;
            this.id = id;
        ...
        internal ReflMember(Resolver resolver, IParser parser, INode parseNode, int id, ReflCallableType declaringType, string name, ReflModifier modifiers, ReflAttribute[] attributes)
            : base(resolver, parser, parseNode, declaringType)
        {
            isTopLevel = false;
            this.id = id;
