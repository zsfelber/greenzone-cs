...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflAttributeArg(Resolver resolver, IParser parser, INode parseNode, ReflAttribute parent, int argIndex, string value)
        ...
        internal ReflAttributeArg(Resolver resolver, IParser parser, INode parseNode, ReflAttribute parent, string argProperty, string value)
            : base(resolver, parser, parseNode, parent)
        {
            this.parent = parent;
            this.argIndex = -1;
