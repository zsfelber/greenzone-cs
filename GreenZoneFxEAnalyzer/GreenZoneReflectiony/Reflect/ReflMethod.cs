...
namespace GreenZoneParser.Reflect
{
    ...
    {
        internal ReflMethod(Resolver resolver, IParser parser, INode parseNode, int id, ReflObjType declaringType, ReflType returnType, string methodName, ReflModifier modifiers, ReflAttribute[] attributes, params ReflMethodArgDefinition[] methodArgs)
