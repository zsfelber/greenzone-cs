...
namespace GreenZoneFxEngine.Gui.Orders
{
    public class OrdersGridView : DataGridView
    {
        ...
        public void Bind(GreenWinFormsMVContext context, OrdersGridController controller)
        {
            new DataGridViewVCBinder(context, this, controller);

            new DataGridColumnVCBinder(context, ticketDataGridViewTextBoxColumn, controller.TicketColumn);
            new DataGridColumnVCBinder(context, expertDataGridViewTextBoxColumn, controller.ExpertColumn);
            new DataGridColumnVCBinder(context, operationDataGridViewTextBoxColumn, controller.OperationColumn);
            new DataGridColumnVCBinder(context, typeDataGridViewTextBoxColumn, controller.TypeColumn);
            new DataGridColumnVCBinder(context, symbolDataGridViewTextBoxColumn, controller.SymbolColumn);
            new DataGridColumnVCBinder(context, lotsDataGridViewTextBoxColumn, controller.LotsColumn);
            new DataGridColumnVCBinder(context, openTimeDataGridViewTextBoxColumn, controller.OpenTimeColumn);
            new DataGridColumnVCBinder(context, openPriceDataGridViewTextBoxColumn, controller.OpenPriceColumn);
            new DataGridColumnVCBinder(context, stopLossDataGridViewTextBoxColumn, controller.StopLossColumn);
            new DataGridColumnVCBinder(context, takeProfitDataGridViewTextBoxColumn, controller.TakeProfitColumn);
            new DataGridColumnVCBinder(context, closeTimeDataGridViewTextBoxColumn, controller.CloseTimeColumn);
            new DataGridColumnVCBinder(context, closePriceDataGridViewTextBoxColumn, controller.ClosePriceColumn);
            new DataGridColumnVCBinder(context, commissionDataGridViewTextBoxColumn, controller.CommissionColumn);
            new DataGridColumnVCBinder(context, swapDataGridViewTextBoxColumn, controller.SwapColumn);
            new DataGridColumnVCBinder(context, profitDataGridViewTextBoxColumn, controller.ProfitColumn);
            new DataGridColumnVCBinder(context, commentDataGridViewTextBoxColumn, controller.CommentColumn);
            new DataGridColumnVCBinder(context, expirationDataGridViewTextBoxColumn, controller.ExpirationColumn);
            new DataGridColumnVCBinder(context, magicNumberDataGridViewTextBoxColumn, controller.MagicNumberColumn);
            new DataGridColumnVCBinder(context, balanceDataGridViewTextBoxColumn, controller.BalanceColumn);

            new ContextMenuStripVCBinder(context, showColumnsCmstr, controller.ShowColumnsCmstr);
        }
    }
}
