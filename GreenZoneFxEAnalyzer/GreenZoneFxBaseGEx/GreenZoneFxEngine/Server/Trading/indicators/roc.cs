...
namespace GreenZoneFxEngine.Trading
{
    ...
    [Indicator("Price Rate of Change", null, "Oscillators")]
    class ROC : ServerIndicatorRuntime
    {
        //--------------------------------------------------------------------
        ...
        public ROC(GreenRmiManager rmiManager, IChartRuntime parent, Mt4ExecutableInfo info, ISeriesManagerCache icache)
            : base(rmiManager, parent, info, icache, IndicatorWindowType.CHART_WINDOW, 6,
        ...
        public ROC(GreenRmiManager rmiManager, IChartRuntime parent, IIndicatorSession session, ISeriesManagerCache icache)
        ...
        int _Period_MA_0 = 13; public int Period_MA_0 { get { return _Period_MA_0; } set { _Period_MA_0 = value; } }        // Ïåðèîä îïîðíîé ÌÀ äëÿ òåêóù. ÒÔ
        ...
        double _K = 2; public double K { get { return _K; } set { _K = value; } }         // Êîýôôèöèåíò óñèëåíèÿ
        //--------------------------------------------------------------- 3 --
        int
           Period_MA_2, Period_MA_3,       // Ðàñ÷¸òíûå ïåðèîäû ÌÀ äëÿ äð. ÒÔ
           Period_MA_02, Period_MA_03,      // Ðàñ÷¸òíûå ïåðèîäû îïîðíûõ ÌÀ 
        ...
        public override int Init()                          // Ñïåöèàëüíàÿ ôóíêöèÿ init()
        {
            ...
            Period_MA_02 = K2 * Period_MA_0;   // Ïåðèîä îïîðíîé ÌÀ äëÿ áëèæ. ÒÔ
            Period_MA_03 = K3 * Period_MA_0;   // Ïåðèîä îïîðíîé ÌÀ äëÿ ñëåä. ÒÔ
            //--------------------------------------------------------------- 7 --
        ...
        public override int OnTick()                         // Ñïåöèàëüíàÿ ôóíêöèÿ start()
        {
            //--------------------------------------------------------------- 9 --
            double
            MA_0, MA_02, MA_03,           // Îïîðíûå ÌÀ äëÿ ðàçíûõ ÒÔ
            ...
            while (i >= 0)                      // Öèêë ïî íåïîñ÷èòàííûì áàðàì
            {
                ...
                Line_2[i] = MA_02 + K * (MA_c - MA_p);// Çíà÷åíèå 2 ëèíèè ñêîðîñòè
                //-------------------------------------------------------- 15 --
                ...
                Line_3[i] = MA_03 + K * (MA_c - MA_p);// Çíà÷åíèå 3 ëèíèè ñêîðîñòè
                //-------------------------------------------------------- 16 --
