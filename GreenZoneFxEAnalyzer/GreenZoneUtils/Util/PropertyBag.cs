...
namespace Flobbster.Windows.Forms
{
	...
	public class PropertyBag : ICustomTypeDescriptor
	{
		...
		/// </summary>
		[Serializable]
		public class PropertySpecCollection : IList, ICloneable
		{
            ...
            public object Clone()
            {
                PropertySpecCollection clone = new PropertySpecCollection();
                clone.innerArray = (ArrayList)innerArray.Clone();
                return clone;
            }
        }
		#endregion
		...
		protected PropertySpecCollection properties;
	...
	/// </summary>
	public class PropertyTable : PropertyBag, ICloneable
	{
		private readonly Dictionary<string,object> propValues;
        ...
        public object Clone()
        {
            PropertyTable clone = new PropertyTable();
            foreach (var e in propValues)
            {
                clone.propValues[e.Key] = e.Value;
            }
            clone.defaultProperty = defaultProperty;
            clone.properties = (PropertySpecCollection)properties.Clone();
            return clone;
        }
    }
}
