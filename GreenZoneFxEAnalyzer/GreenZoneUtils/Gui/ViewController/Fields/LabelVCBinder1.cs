...
{
    public class LabelVCBinder1 : ControlVCBinder1<Label,LabelledController>
    {
        public LabelVCBinder1(WinFormsMVContext context, Label control, LabelledController controller)
