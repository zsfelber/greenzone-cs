...
{
    public class TrackBarVCBinder : ControlVCBinder1<TrackBar, ProgressTrackController>
    {
        public TrackBarVCBinder(WinFormsMVContext context, TrackBar control, ProgressTrackController controller)
