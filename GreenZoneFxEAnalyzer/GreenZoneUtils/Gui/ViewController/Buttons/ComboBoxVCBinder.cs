...
{
    public class ComboBoxVCBinder : ControlVCBinder1<ComboBox,ComboController>
    {

        public ComboBoxVCBinder(WinFormsMVContext context, ComboBox control, ComboController controller)
